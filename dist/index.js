...
var SelectedNodesContext = React__default.createContext();
var SelectedNodesDispatchContext = React__default.createContext();
...
var Stage = function Stage(_ref) {
  ...
  var dispatchSelectedNodes = React__default.useContext(SelectedNodesDispatchContext);
  var wrapper = React__default.useRef();
...
var createSVG = function createSVG(_ref5) {
  ...
  path.setAttribute("stroke", "#758696");
...
var Input = function Input(_ref3) {
  ...
  return React__default.createElement(
    ...
    (!controls.length || !controls.length || isConnected) && React__default.createElement(
      "label",
      { className: styles$4.portLabel },
      label || defaultLabel
    ),
    controls.length && !isConnected ? React__default.createElement(
      "div",
...
var Node = function Node(_ref) {
  ...
  var nodesDispatch = React__default.useContext(NodeDispatchContext);
  var stageState = React__default.useContext(StageContext);
  var selectedNodesContext = React__default.useContext(SelectedNodesContext);
  var dispatchSelectedNodes = React__default.useContext(SelectedNodesDispatchContext);
  ...
  var titleEditor = React__default.useRef();
  ...
  var _React$useState9 = React__default.useState(name ? name : label),
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      isRenaming ? React__default.createElement(
        "div",
...
exports.NodeEditor = function NodeEditor(_ref, ref) {
  ...
  var _React$useReducer7 = React__default.useReducer(selectedNodesReducer, []),
  ...
  var _React$useReducer9 = React__default.useReducer(stageReducer, {
