...
var createSVG = function createSVG(_ref5) {
  ...
  path.setAttribute("stroke", "#D0CCD0");
...
var Node = function Node(_ref) {
  ...
  var titleBarElements = function titleBarElements() {
    var elements = [];
    if (isRenaming) {
      elements.push(React__default.createElement("input", {
        type: "text",
